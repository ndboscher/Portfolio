...
export default function ComcastPage() {
  const comcastImages = GALLERY.Comcast;
    ...
    <div className="flex">
      ...
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-8">
          <h1 className="text-5xl font-bold tracking-tight lg:text-6xl">Comcast Project</h1>
          <p className="mt-4 text-lg text-muted-foreground">
            A sleek and captivating description of the Comcast project goes here.
        ...
        <section className="mb-12">
          ...
          <MasonryGallery images={comcastImages} />
        </section>
      </div>
    </div>
  );
