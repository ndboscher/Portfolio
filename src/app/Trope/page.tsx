    ...
    <div>
      ...
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-8">
          <h1 className="text-5xl font-bold tracking-tight lg:text-6xl">Trope Wanted Poster 1 Project</h1>
          <p className="mt-4 text-lg text-muted-foreground">
            A sleek and captivating description of the Trope Wanted Poster 1 project goes here.
        ...
        <section className="mb-12">
          ...
          <MasonryGallery images={tropeImages} />
        </section>
      </div>
    </div>
  );
