...
export default function Page() {
  ...
  return (
      ...
      <ThemeSection sectionId="about" defaultTheme="light">
      ...
      <ThemeSection sectionId="work" defaultTheme="dark"> 
      ...
      <ThemeSection sectionId="education" defaultTheme="light">
        <div className="flex min-h-0 flex-col gap-y-3">
      ...
      <ThemeSection sectionId="skills" defaultTheme="dark">
        <div className="flex min-h-0 flex-col gap-y-3">
      ...
      <ThemeSection sectionId="projects" defaultTheme="light">
      ...
      <ThemeSection sectionId="hackathons" defaultTheme="dark">
        <div className="space-y-12 w-full py-12">
      ...
      <ThemeSection sectionId="contact" defaultTheme="light">
